...
func (d *DIBuilder) CreateLexicalBlockFile(
	diScope Metadata,
	diFile Metadata,
	discriminator int,
) Metadata {
...
// global variable.
func (d *DIBuilder) CreateGlobalVariableExpression(
	diScope Metadata,
	g DIGlobalVariableExpression,
) Metadata {
...
func (d *DIBuilder) CreateReplaceableCompositeType(
	scope Metadata,
